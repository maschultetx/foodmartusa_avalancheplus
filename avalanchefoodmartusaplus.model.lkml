connection: "avalanchefoodmartusaplus"

# include all the views
include: "*.view"

datagroup: avalanchefoodmartusaplus_default_datagroup {
  sql_trigger: SELECT CURRENT_TIMESTAMP;;
  max_cache_age: "0 seconds"
}

persist_with: avalanchefoodmartusaplus_default_datagroup
...
explore: sales_fact_exp {
  join: product {
    type: left_outer
    sql_on: ${sales_fact_exp.product_id} = ${product.product_id} ;;
    relationship: many_to_one
  }

  join: customer {
    type: left_outer
    sql_on: ${sales_fact_exp.customer_id} = ${customer.customer_id} ;;
    relationship: many_to_one
  }

  join: promotion {
    type: left_outer
    sql_on: ${sales_fact_exp.promotion_id} = ${promotion.promotion_id} ;;
    relationship: many_to_one
  }

  join: store {
    type: left_outer
    sql_on: ${sales_fact_exp.store_id} = ${store.store_id} ;;
    relationship: many_to_one
  }
...
explore: sales_fact_load_source2 {
  join: product {
    type: left_outer
    sql_on: ${sales_fact_load_source2.product_id} = ${product.product_id} ;;
    relationship: many_to_one
  }

  join: customer {
    type: left_outer
    sql_on: ${sales_fact_load_source2.customer_id} = ${customer.customer_id} ;;
    relationship: many_to_one
  }

  join: promotion {
    type: left_outer
    sql_on: ${sales_fact_load_source2.promotion_id} = ${promotion.promotion_id} ;;
    relationship: many_to_one
  }

  join: store {
    type: left_outer
    sql_on: ${sales_fact_load_source2.store_id} = ${store.store_id} ;;
    relationship: many_to_one
  }
...
explore: view_50m {
  join: product {
    type: left_outer
    sql_on: ${view_50m.product_id} = ${product.product_id} ;;
    relationship: many_to_one
  }

  join: promotion {
    type: left_outer
    sql_on: ${view_50m.promotion_id} = ${promotion.promotion_id} ;;
    relationship: many_to_one
  }

  join: customer {
    type: left_outer
    sql_on: ${view_50m.customer_id} = ${customer.customer_id} ;;
    relationship: many_to_one
  }

  join: store {
    type: left_outer
    sql_on: ${view_50m.store_id} = ${store.store_id} ;;
    relationship: many_to_one
  }
...
explore: view_75m {
  join: product {
    type: left_outer
    sql_on: ${view_75m.product_id} = ${product.product_id} ;;
    relationship: many_to_one
  }

  join: promotion {
    type: left_outer
    sql_on: ${view_75m.promotion_id} = ${promotion.promotion_id} ;;
    relationship: many_to_one
  }

  join: customer {
    type: left_outer
    sql_on: ${view_75m.customer_id} = ${customer.customer_id} ;;
    relationship: many_to_one
  }

  join: store {
    type: left_outer
    sql_on: ${view_75m.store_id} = ${store.store_id} ;;
    relationship: many_to_one
  }
