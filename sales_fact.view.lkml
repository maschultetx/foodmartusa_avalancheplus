view: sales_fact {
  sql_table_name: dbuser.sales_fact ;;
  ...
  measure: total_store_sales {
    ...
    link: {
      ...
      url: "/dashboards/45?Region={{ region.name._value | encode_uri }}&Product%20Family={{ product_class.product_family._value | encode_uri }}"
